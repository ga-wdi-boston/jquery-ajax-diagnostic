...
```sh
curl --include --request POST http://www.example.com/donuts ("French Cruller", "$"+"0.99")
```
...
```sh
curl --include --request PATCH http://www.example.com/donuts/42 ("Krüller")
```
